...
import com.mole.androidcodestudy.adapter.HeightMeasurableAdapter
...
class AdaptiveHeightViewPager2 @JvmOverloads constructor(
     ...
     * 重写setter方法，确保adapter实现了HeightMeasurableAdapter接口
     */
    fun getViewPager(): ViewPager2 = viewPager

    /**
     * 设置adapter，确保它实现了HeightMeasurableAdapter接口
     */
    fun <T> setAdapter(adapter: T) where T : RecyclerView.Adapter<out RecyclerView.ViewHolder>, T : HeightMeasurableAdapter {
        // 设置ViewPager引用到Adapter
